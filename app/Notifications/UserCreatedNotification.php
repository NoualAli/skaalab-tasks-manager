...
class UserCreatedNotification extends Notification
{
    ...
    private function getContent(): array
    {
        ...
        $ligns = [
            ...
            'Pour une meilleure expérience d\'utilisation de la plateforme ' . env('APP_NAME') . ', nous vous recommandons d\'utiliser un navigateur web tel que Microsoft Edge ou Google Chrome',
            'Pour toutes difficultés ou informations complémentaires, il y a lieu de se rapprocher de l\'administrateur de la plateforme',
        ];
        return $ligns;
    }
    ...
    {
        return 'CREATION DE VOTRE COMPTE - PLATEFROME ' . env('APP_NAME');
    }
